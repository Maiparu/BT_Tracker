...
public class MainActivity extends AppCompatActivity implements
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.MainButton4:
                ...
                // Verify that the intent toLink2 will resolve properly
                if(toLink2.resolveActivity(getPackageManager()) != null){
    ...
    public void setReminder(View view) {
        ...
        // set up a repeating alarm so that the notification reminder gets friend at the set interval
    ...
    private void createNotificationChannel(){
        ...
        // CAUTION: It's Oreo's O, not number O!!!
